...
{
    public static class PerlinNoise1D
    {
        private static double CubicInterpolate(double v0, double v1, double v2, double v3, double x)
        {
            ...
            return (p * System.Math.Pow(x, 3))
                   + (q * System.Math.Pow(x, 2))
                   + (r*x)
                   + s;
        }
        ...
        public static float OctavePerlin(float x, int octaves, float persistence)
        {
            var total = 0f;
            var frequency = 1f;
            var amplitude = 1f;
            ...
            {
                total += Calculate(x*frequency)*amplitude;
